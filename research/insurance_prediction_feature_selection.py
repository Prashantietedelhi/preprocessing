...
"GrossAnnualSalary", "EmployeeStatus", "MaritalStatus",
"SpouseRelationShip", "ChildCount", 
"PlandesignID", "BenefitTypeID", "BenefitTypeIdentifier","PlanTypeIdentifier"]


datasets = pd.read_csv("../data/data_plantype.csv",header = None, names = parameters)
datasets = datasets.drop_duplicates()

columnName = ["GrossAnnualSalary"]
...
order = ["EmployeeAge","GrossAnnualSalary","ChildCount","Gender","EmployeeStatus","MaritalStatus","SpouseRelationShip","CompanyID","PlanTypeIdentifier"]
medical_datasets = medical_datasets[order]


labelencoders = {}

categorical = ["Gender","EmployeeStatus","MaritalStatus","SpouseRelationShip","CompanyID"]
